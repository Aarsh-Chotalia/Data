...
load("S"+num2str(Subject_id(1))+"S"+num2str(1)+".mat");
x1=(Oz+O1+O2)/3;
load("S"+num2str(Subject_id(1))+"S"+num2str(2)+".mat");
x2=(Oz+O1+O2)/3;
load("S"+num2str(Subject_id(2))+"S"+num2str(1)+".mat");
x3=(Oz+O1+O2)/3;
load("S"+num2str(Subject_id(2))+"S"+num2str(2)+".mat");
x4=(Oz+O1+O2)/3;
...
saveas(gcf,"S_int_"+num2str(Subject_id(1))+num2str(Subject_id(2))+"_corr",'png')
fname="S_int_"+num2str(Subject_id(1))+num2str(Subject_id(2))+"corr_data"
save(fname)
